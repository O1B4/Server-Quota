...
public class RequestReservationRoomDTO {
    ...
    public RequestReservationRoomDTO(String roomName, String meetingKind, String meetingLocation, LocalDate rangeStart, LocalDate rangeEnd, String durationKind, int duration, List<AvailableTimeDTO> availableTime, List<LocalDate> excludeDate, String roomDescription, String roomUrl) {
        this.roomName = roomName;
        this.meetingKind = meetingKind;
        this.meetingLocation = meetingLocation;
        this.rangeStart = rangeStart;
